...
<Path d="M375.037 122.64C375.037 122.64 359.61 63.7556 211.055 102.878C62.5 142 1.47118 120.73 0.037418 122.304L0.646447 -558L375.646 -557.664L375.037 122.64Z" fill="white"/>
        ...
        <Svg width="24" height="30" viewBox="0 0 24 30" fill="none" xmlns="http://www.w3.org/2000/svg" style={{marginLeft: 20, }}>
            ...
            <Text style={{ fontSize: 25, fontWeight: 'bold', color: '#2c2c2c' }}>Events</Text>
      ...
      >
        ...
        <View style={{ flexDirection:'row', justifyContent: 'space-around', marginTop: 10, marginRight: 10, marginLeft: 10 }}>
            <TouchableOpacity style={{ flexDirection: 'column',}}>
                <Text style={{ fontSize: 15, fontWeight: 'bold', color: '#ffffff' }}>Lun</Text>
                <View style={{ width: 30, height: 30, borderRadius: 30, backgroundColor: '#FA4A0C', marginTop: 5 }}>
                    <Text style={{ fontSize: 15, fontWeight: 'bold', color: '#ffffff', textAlign: 'center', padding: 5 }}>14</Text>
                </View>
            </TouchableOpacity>
            <TouchableOpacity style={{ flexDirection: 'column',}}>
                <Text style={{ fontSize: 15, fontWeight: 'bold', color: '#ffffff' }}>Mar</Text>
                <View style={{ width: 30, height: 30, borderRadius: 30, backgroundColor: '#ffffff', marginTop: 5 }}>
                    <Text style={{ fontSize: 15, fontWeight: 'bold', color: '#2c2c2c', textAlign: 'center', padding: 5 }}>15</Text>
                </View>
            </TouchableOpacity>
            <TouchableOpacity style={{ flexDirection: 'column',}}>
                <Text style={{ fontSize: 15, fontWeight: 'bold', color: '#ffffff' }}>Mer</Text>
                <View style={{ width: 30, height: 30, borderRadius: 30, backgroundColor: '#ffffff', marginTop: 5 }}>
                    <Text style={{ fontSize: 15, fontWeight: 'bold', color: '#2c2c2c', textAlign: 'center', padding: 5 }}>16</Text>
                </View>
            </TouchableOpacity>
            <TouchableOpacity style={{ flexDirection: 'column',}}>
                <Text style={{ fontSize: 15, fontWeight: 'bold', color: '#ffffff' }}>Jeu</Text>
                <View style={{ width: 30, height: 30, borderRadius: 30, backgroundColor: '#ffffff', marginTop: 5 }}>
                    <Text style={{ fontSize: 15, fontWeight: 'bold', color: '#2c2c2c', textAlign: 'center', padding: 5 }}>17</Text>
                </View>
            </TouchableOpacity>
            <TouchableOpacity style={{ flexDirection: 'column',}}>
                <Text style={{ fontSize: 15, fontWeight: 'bold', color: '#ffffff' }}>Ven</Text>
                <View style={{ width: 30, height: 30, borderRadius: 30, backgroundColor: '#ffffff', marginTop: 5 }}>
                    <Text style={{ fontSize: 15, fontWeight: 'bold', color: '#2c2c2c', textAlign: 'center', padding: 5 }}>18</Text>
                </View>
            </TouchableOpacity>
            <TouchableOpacity style={{ flexDirection: 'column',}}>
                <Text style={{ fontSize: 15, fontWeight: 'bold', color: '#ffffff' }}>Sam</Text>
                <View style={{ width: 30, height: 30, borderRadius: 30, backgroundColor: '#ffffff', marginTop: 5 }}>
                    <Text style={{ fontSize: 15, fontWeight: 'bold', color: '#2c2c2c', textAlign: 'center', padding: 5 }}>19</Text>
                </View>
            </TouchableOpacity>
            <TouchableOpacity style={{ flexDirection: 'column',}}>
                <Text style={{ fontSize: 15, fontWeight: 'bold', color: '#ffffff' }}>Dim</Text>
                <View style={{ width: 30, height: 30, borderRadius: 30, backgroundColor: '#ffffff', marginTop: 5 }}>
                    <Text style={{ fontSize: 15, fontWeight: 'bold', color: '#2c2c2c', textAlign: 'center', padding: 5 }}>20</Text>
                </View>
            </TouchableOpacity>
        </View>
        ...
        <View style={{ flexDirection:'row', justifyContent: 'space-around', alignSelf:'center', marginTop: 10  }}>
            ...
            <Svg width="36" height="40" viewBox="0 0 36 40" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ alignSelf: 'center', marginTop: 12 }}>
                <Path d="M20.3438 35.257C19.9125 35.257 19.5625 35.607 19.5625 36.0383C19.5625 36.4695 19.9125 36.8195 20.3438 36.8195C20.775 36.8195 21.125 36.4695 21.125 36.0383C21.125 35.607 20.775 35.257 20.3438 35.257Z" fill="black"/>
                <Path d="M9.36719 15.6477C8.9357 15.6477 8.58594 15.9974 8.58594 16.4289V31.3508C8.58594 31.7823 8.9357 32.132 9.36719 32.132C9.79867 32.132 10.1484 31.7823 10.1484 31.3508V16.4289C10.1484 15.9974 9.79867 15.6477 9.36719 15.6477Z" fill="black"/>
                <Path d="M15.6172 15.6477C15.1857 15.6477 14.8359 15.9974 14.8359 16.4289V31.3508C14.8359 31.7823 15.1857 32.132 15.6172 32.132C16.0487 32.132 16.3984 31.7823 16.3984 31.3508V16.4289C16.3984 15.9974 16.0487 15.6477 15.6172 15.6477Z" fill="black"/>
            ...
            <View style={{ flexDirection: 'column' }}>
            <TouchableOpacity 
            onPress={() => navigation.navigate('eventmanger')}
            style={{ width: 70, height: 70, backgroundColor: '#ffffff', marginTop: 20, marginRight: 20, marginLeft: 20, borderRadius: 10, flexDirection: 'column' }}>
