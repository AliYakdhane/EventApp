        ...
        <Path d="M9.06339 27.5C9.76838 28.9725 11.2609 30 12.9996 30C14.7383 30 16.2309 28.9725 16.9359 27.5H9.06339Z" fill="#2C2C2C"/>
                    ...
                    <View style={{flexDirection:'column', alignItems: 'center'}}>
                        ...
                        style={{flexDirection:'column',marginTop: 20, width: '50%', height: 50, backgroundColor: '#FA4A0C', borderRadius: 20, alignSelf: 'center', marginRight: 20}}>
                                <Text style={{ fontWeight:'bold', fontSize: 15, color: '#ffffff', alignSelf: 'center', marginLeft: 10, padding: 15 }}>Déconnexion </Text>
                    ...
                    />
                        ...
                        <TouchableOpacity 
                        onPress={() => {
                            Linking.openURL('https://sloth-lab.com/');
                        }}
                        ...
                        <Text note style={{ color: "#FA4A0C",  alignSelf: "center", paddingBottom: 2, fontWeight: 'bold'}} > By Sloth-Lab</Text>
